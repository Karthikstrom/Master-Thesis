...
class Agent:
    def __init__(self,input_dims,alpha=0.00005,beta=0.00001,env=None,gamma=0.99,
        ...
        for i in range(self.no_of_episodes+1):
            noise_temp = self.Gaussian_Noise()
            noise_temp_list.append(noise_temp)
            
        self.gaussian_noise = np.concatenate(noise_temp_list)
    ...
    def choose_action(self,observation,evaluate=False):
        ...
        #print(actions)
        noise_tens=[self.gaussian_noise[self.step_counter]]
...
plt.savefig(r"C:\Users\Karthikeyan\Desktop\Github\Master-Thesis\Main_Folder\21_EMS_RL -DDPG_WO_PV_2.1.4\Figures\bat_rtp.jpeg",dpi=200)
plt.show()
#%% SOC
import seaborn as sns
sns.set_style("white")
...
plt.savefig(r"C:\Users\Karthikeyan\Desktop\Github\Master-Thesis\Main_Folder\21_EMS_RL -DDPG_WO_PV_2.1.4\Figures\soc.jpeg",dpi=200)
plt.show()
...
plt.savefig(r"C:\Users\Karthikeyan\Desktop\Github\Master-Thesis\Main_Folder\21_EMS_RL -DDPG_WO_PV_2.1.4\Figures\Imp_rtp.jpeg",dpi=200)
plt.show()
...
plt.savefig(r"C:\Users\Karthikeyan\Desktop\Github\Master-Thesis\Main_Folder\21_EMS_RL -DDPG_WO_PV_2.1.4\Figures\Imp_Exp.jpeg",dpi=200)
plt.show()
#%% Cost difference
import seaborn as sns
sns.set_style("white")
...
plt.savefig(r"C:\Users\Karthikeyan\Desktop\Github\Master-Thesis\Main_Folder\21_EMS_RL -DDPG_WO_PV_2.1.4\Figures\cost.jpeg",dpi=200)
plt.show()
#%% Energy balance
