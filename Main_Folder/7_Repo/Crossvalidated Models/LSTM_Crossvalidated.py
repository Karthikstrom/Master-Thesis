...
from Essential_functions import load_data2,data_split_array,split_sequence_single,split_sequence_single_array,metrics
...
def crossvalid(i):
    ...
    # scaler=scaler.fit(train_temp)
    # train_temp=scaler.transform(train_temp)
    ...
    model_lstm.add(LSTM(64, activation='relu', input_shape=(train_x.shape[1], train_x.shape[2])))
...
plt.savefig('lstm_output1.jpeg',dpi=500)
plt.show()
