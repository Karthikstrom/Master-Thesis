...
class EMSenv(gym.Env):
    ...
    def __init__(self):
        ...
        #Battery action 
        self.bat_act_min=-2.8
        self.bat_act_max=2.8
        ...
        self.obs_low=np.array([self.min_load,self.min_price,self.min_pv,self.min_hour,
                               ...
                               self.ps_min,self.pp_min,self.grid_p_low,self.bat_act_min])
        ...
        self.obs_high=np.array([self.max_load,self.max_price,self.max_pv,self.max_hour,
                                ...
                                self.ps_max,self.pp_max,self.grid_p_high,self.bat_act_max])
    ...
    def reset(self):
        ...
        #pp=pp/self.pp_max
        bat_act=round(self.rng.uniform(self.bat_act_min, self.bat_act_max), 3)
        ...
        self.current_obs=np.array([self.load[0],self.price[0],self.pv[0],self.hour_feature[0],
                                  ...
                                  soc,pb_in,pb_out,pb_imp,pb_exp,ps,pp,grid_p,bat_act])
    ...
    def step(self,a1,a2):
        ...
        #grid_p_excess
        #grid_p has to be positive
        grid_p=self.current_obs[0]-pb_exp_load
        
        
        load_total=pb_exp_load+grid_p
        ...
        bat_action=pb_imp_temp-pb_exp_temp-a2
        
        
        #Total export of battery
        pb_exp_temp=pb_exp_temp+a2
        
        #Total import of battery
        ...
        #to make sure discharge does not go over the limit of 2.8
        bat_sum=abs(a1+a2)
        
        if bat_sum>2.8:
            reward_5=-(bat_sum-2.8)
        else:
            reward_5=0
        ...
        reward=6.5*reward_1+6.5*reward_2+reward_3+3*reward_4+5*reward_5+10*reward_6
        ...
        next_obs=[next_load,next_price,next_pv,next_hour,next_3h_price,
                  ...
                  next_soc,next_pb_in,next_pb_out,pb_imp_temp,pb_exp_temp,ps,pp,grid_p,bat_action]
        done=False
        ...
        r=[reward_1,reward_2,reward_3,reward_4,reward_5,reward_6]
