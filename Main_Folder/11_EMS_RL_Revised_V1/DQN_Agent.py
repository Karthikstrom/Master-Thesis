...
Discount_rate=0.1
model_filename = 'real_v3.h5'


# Exploration settings
epsilon = 1  # not a constant, going to be decayed
EPSILON_DECAY = 0.9945 #0.997-700 episodic learning
MIN_EPSILON = 0.1
epsilon_dec=[]
#%% Creating the agent
class DQNAgent:
...
for episode in tqdm(range(1,Episodes+1),ascii=True,unit="episode"):
    ...
    while not done:
        ...
        new_state,reward,done,rew=env.step(action)
        print('R1:',rew[0],'R2',rew[1],'R3',rew[2],'R4',rew[3])
...
#%% Load Model
loaded_model = load_model('real_v3.h5')
...
for i in range(test_episode):
        ...
        while not done:
            ...
            soc_list.append(current_state[5])
