...
class Agent:
    def __init__(self,input_dims,alpha=0.00001,beta=0.00002,env=None,gamma=0.99,
                 n_actions=1,max_size=30000,tau=0.05,batch_size=64,no_of_episodes=700):
    ...
    def choose_action(self,observation,evaluate=False):
        ...
        noise=self.x[self.step_counter]
...
if __name__ == '__main__':
    env=EMSenv()
    n_games=2000
    agent=Agent(input_dims=env.observation_space.shape,env=env,n_actions=env.action_space.shape[0],no_of_episodes=n_games)
