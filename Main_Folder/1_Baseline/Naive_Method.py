...
df['shift_1']=df['Global_active_power'].shift(24)
...
#%% Metrics
print("Train data metrics",metrics(train['Global_active_power'],train['shift_1']))
print("Test data metrics",metrics(test['Global_active_power'],test['shift_1']))
#%% Visualization
# fig,ax=plt.subplots()
