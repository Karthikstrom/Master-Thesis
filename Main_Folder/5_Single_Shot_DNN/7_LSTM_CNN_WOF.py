...
path=r"C:\Users\Karthikeyan\Desktop\Github\Master-Thesis\Main_Folder\5_Single_Shot_DNN\Plots\MS_CNNLSTM.jpeg"
...
bx.set_ylabel("Load")
plt.title("Multi Step Single Shot CNN-LSTM Actual vs Prediction")
plt.xlim(600,1000)
plt.legend()
