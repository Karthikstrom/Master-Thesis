...
path=r"C:\Users\Karthikeyan\Desktop\Github\Master-Thesis\Main_Folder\5_Single_Shot_DNN\Plots\MS_LSTM.jpeg"
...
bx.set_ylabel("Load")
plt.title("Multi Step Single Shot LSTM Actual vs Prediction")
plt.xlim(600,1000)
plt.legend()
