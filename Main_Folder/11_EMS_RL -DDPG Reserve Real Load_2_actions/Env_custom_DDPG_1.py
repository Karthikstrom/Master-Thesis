...
class EMSenv(gym.Env):
    ...
    def __init__(self):
        ...
        self.obs_low=np.array([self.min_load,self.min_price,self.min_pv,self.min_hour,
                               ...
                               self.soc_min,self.pb_in_min,self.pb_out_min])
        ...
        self.obs_high=np.array([self.max_load,self.max_price,self.max_pv,self.max_hour,
                                ...
                                self.soc_max,self.pb_in_max,self.pb_out_max])
    ...
    def step(self,a1,a2):
        ...
        if (self.current_obs[12]<=self.soc_min):
            reward_1=-10*abs(self.soc_min-self.current_obs[12])
            
        elif (self.current_obs[12]>=self.soc_max):
            reward_1=-10*(self.current_obs[12]-self.soc_max)
        ...
        next_obs=[next_load,next_price,next_pv,next_hour,next_3h_price,
                  ...
                  next_soc,next_pb_in,next_pb_out]
...
for i in range(1):
    ...
    while done==False:
        ...
        a1 = action[0]
        a2 = action[1]
        obs,r,done,_=test_env.step(a1,a2)
        print(obs)
# #%%
