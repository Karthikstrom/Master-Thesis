...
class CriticNetwork(keras.Model):
    def __init__(self,fc1_dims=248,fc2_dims=248,name='critic',chkpt_dir='tmp/ddpg2'):
...
class ActorNetwork(keras.Model):
    def __init__(self,fc1_dims=248,fc2_dims=248,n_actions=1,name='actor',chkpt_dir='tmp/ddpg2'):
...
class Agent:
    def __init__(self,input_dims,alpha=0.00001,beta=0.00002,env=None,gamma=0.99,
                 n_actions=1,max_size=30000,tau=0.005,fc1=128,fc2=128,batch_size=32,noise=0.5):
...
ax2=ax.twinx()
ax2.plot(df_final['Load'],color='g')
plt.show()
...
fig,bx=plt.subplots()
bx.plot(df_final['Bat_actions'])
bx.plot(df_final['Load'])
bx.plot(df_final['PV'])
bx2=bx.twinx()
bx2.plot(df_final['Grid_ex'],color='r')
plt.plot()
#%% Multiple axis plot
