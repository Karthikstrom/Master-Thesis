...
path=r"C:\Users\Karthikeyan\Desktop\Github\Master-Thesis\Main_Folder\6_Autoregressive_DNN\Plots\AR_LSTM.jpeg"
...
bx.set_ylabel("Load")
plt.title("Multi Step (Regressive) LSTM Actual vs Prediction")
plt.xlim(600,1000)
plt.legend()
