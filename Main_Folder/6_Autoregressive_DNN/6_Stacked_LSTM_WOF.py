...
path=r"C:\Users\Karthikeyan\Desktop\Github\Master-Thesis\Main_Folder\6_Autoregressive_DNN\Plots\AR_SLSTM.jpeg"
...
bx.set_ylabel("Load")
plt.title("Multi Step (Regressive) Stacked LSTM Actual vs Prediction")
plt.xlim(600,1000)
plt.legend()
