...
rnn_history =rnn_model.fit(train_x,train_y, validation_data=(val_x, val_y), epochs=10, verbose=2)
...
path=r"C:\Users\Karthikeyan\Desktop\Github\Master-Thesis\Main_Folder\6_Autoregressive_DNN\Plots\AR_SimpleRNN.jpeg"
...
bx.set_ylabel("Load")
plt.title("Multi Step (Regressive) SimpleRNN Actual vs Prediction")
plt.xlim(600,1000)
plt.legend()
