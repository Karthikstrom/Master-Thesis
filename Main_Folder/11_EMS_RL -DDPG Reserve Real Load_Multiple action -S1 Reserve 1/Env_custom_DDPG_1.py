...
class EMSenv(gym.Env):
    ...
    def step(self,a1,a2,a3,a4,a5,a6):
        ...
        #Grid Import reward    
            ...
            # else:
            #     reward_2=-3
            reward_2= -10*(abs(g2l) + abs(s2b))
            grid_exp=0
            grid_imp=a3+abs(a6)
        # if (0.8*self.current_obs[2]<s_total<1.2*self.current_obs[2]):
        #     reward_3=0
        # else:
        #     reward_3=-3
        
        # if (0.8*self.current_obs[0]<l_total<1.2*self.current_obs[0]):
        #     reward_4=0
        # else:
        #     reward_4=-3
        
        reward_3=-3*abs(self.current_obs[2]-s_total)
        reward_4=-3*abs(self.current_obs[0]-l_total)
            
        
        reward_5=-3*(grid_imp-grid_exp)*self.current_obs[1]
        
        # if (0>=grid_exp>=3)|(0>=grid_imp>=3):
        #     reward_5=-5*(grid_imp-grid_exp)*self.current_obs[1]
        # else:
        #     reward_5=-1000
