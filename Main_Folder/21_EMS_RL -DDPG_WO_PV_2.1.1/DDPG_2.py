...
class Agent1:
    def __init__(self,input_dims,alpha=0.00005,beta=0.00001,env=None,gamma=0.99,
                 n_actions=1,max_size=50000,tau=0.05,batch_size=32,no_of_episodes=8000,sig_ini=None):
        ...
        self.a1_noise=self.OU_Noise()
        self.a2_noise=self.OU_Noise()
...
if __name__ == '__main__':
    env=EMSenv()
    agent1=Agent1(input_dims=env.observation_space.shape,env=env,n_actions=1,sig_ini=0.6)
    agent2=Agent2(input_dims=env.observation_space.shape,env=env,n_actions=1,sig_ini=0.3)
    n_games=8000
    ...
    for i in range(n_games):
        ...
        while not done:
            ...
            print('r1',r[0],'r2',r[1],'r3',r[2],'r4',r[3],'r5',r[4])
            score+=reward
...
#plt.savefig(r"C:\Users\Karthikeyan\Desktop\Github\Master-Thesis\Main_Folder\21_EMS_RL -DDPG_WO_PV_2.0\Figures\bat_rtp.jpeg",dpi=200)
plt.show()
#%% SOC
import seaborn as sns
sns.set_style("white")
...
#plt.savefig(r"C:\Users\Karthikeyan\Desktop\Github\Master-Thesis\Main_Folder\21_EMS_RL -DDPG_WO_PV_2.0\Figures\soc.jpeg",dpi=200)
plt.show()
...
#plt.savefig(r"C:\Users\Karthikeyan\Desktop\Github\Master-Thesis\Main_Folder\21_EMS_RL -DDPG_WO_PV_2.0\Figures\Imp_rtp.jpeg",dpi=200)
plt.show()
...
#plt.savefig(r"C:\Users\Karthikeyan\Desktop\Github\Master-Thesis\Main_Folder\21_EMS_RL -DDPG_WO_PV_2.0\Figures\Imp_Exp.jpeg",dpi=200)
plt.show()
#%% Cost difference
import seaborn as sns
sns.set_style("white")
...
#plt.savefig(r"C:\Users\Karthikeyan\Desktop\Github\Master-Thesis\Main_Folder\21_EMS_RL -DDPG_WO_PV_2.0\Figures\cost.jpeg",dpi=200)
plt.show()
#%% Energy balance
