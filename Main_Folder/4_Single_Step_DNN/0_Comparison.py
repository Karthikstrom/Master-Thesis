...
#%% Loading Models
MLP=pickle.load(open('SS_MLP.sav','rb'))
CNN=pickle.load(open('SS_CNN.sav','rb'))
RNN=pickle.load(open('SS_RNN.sav','rb'))
LSTM=pickle.load(open('SS_LSTM.sav','rb'))
SLSTM=pickle.load(open('SS_SLSTM.sav','rb'))
BLSTM=pickle.load(open('SS_BLSTM.sav','rb'))
CNNLSTM=pickle.load(open('SS_CNNLSTM.sav','rb'))
ConvLSTM=pickle.load(open('SS_ConvLSTM.sav','rb'))
EncDecLSTM=pickle.load(open('SS_EncDecLSTM.sav','rb'))
#%% Predicting
...
plt.ylabel("MAE")
plt.title("Single Step Mean Absolute Error Comparison")
plt.show()
...
plt.xticks(y_pos,x_ticks, rotation=45)
plt.ylabel("MAPE(%)")
plt.title("Single Step Mean Absolute Percentage Error Comparison")
plt.show()
...
plt.xticks(y_pos,x_ticks, rotation=45)
plt.ylabel("RMSE")
plt.title("Single Step Root Mean squared Error Comparison")
plt.show()