...
path=r"C:\Users\Karthikeyan\Desktop\Github\Master-Thesis\Main_Folder\4_Single_Step_DNN\Plots\SS_EncDecLSTM.jpeg"
...
bx.set_ylabel("Load")
plt.title("Single Step EncDecLSTM Actual vs Prediction")
plt.xlim(600,800)
plt.legend()
