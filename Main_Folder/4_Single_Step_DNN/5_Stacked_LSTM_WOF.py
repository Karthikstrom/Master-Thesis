...
path=r"C:\Users\Karthikeyan\Desktop\Github\Master-Thesis\Main_Folder\4_Single_Step_DNN\Plots\SS_SLSTM.jpeg"
...
bx.set_ylabel("Load")
plt.title("Single Step Stacked LSTM Actual vs Prediction")
plt.xlim(800,1000)
plt.legend()
