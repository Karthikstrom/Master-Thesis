...
model_mlp.add(Dense(84,activation='relu',input_dim=train_x.shape[1]))
model_mlp.add(Dense(24,activation='relu'))
model_mlp.add(Dense(op_steps))
model_mlp.compile(loss='mse', optimizer='adam')
model_mlp.summary()

mlp_history = model_mlp.fit(train_x, train_y, validation_data=(val_x,val_y), epochs=100, verbose=2)
