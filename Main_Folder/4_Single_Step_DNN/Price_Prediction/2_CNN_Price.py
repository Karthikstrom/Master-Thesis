...
from Essential_functions import real_load,metrics,data_split,load_wholedata
...
#%% CNN Model
cnn_model=Sequential()
cnn_model.add(Conv1D(filters=8, kernel_size=4, activation='relu', input_shape=(train_x.shape[1],train_x.shape[2])))
cnn_model.add(Flatten())
cnn_model.add(Dense(10, activation='relu'))
cnn_model.add(Dense(op_steps))
cnn_model.compile(loss=root_mean_squared_error, optimizer='adam')
cnn_model.summary()
