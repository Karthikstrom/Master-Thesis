...
plt.savefig(r"C:\Users\Karthikeyan\Desktop\Thesis\Mid_Term_Presentation\Common_plots\Price_loss.jpeg",format="jpeg",dpi=300)
plt.show()
#%% Save Model
# filename='SS_MLP.sav'
...
ax.set_ylabel("Price (€/Kwh)",fontsize=24,**csfont)
plt.yticks(fontsize=20,**csfont)
plt.xticks(fontsize=20,**csfont)
...
#plt.savefig(r"C:\Users\Karthikeyan\Desktop\Thesis\Mid_Term_Presentation\Common_plots\Price_best.jpeg",format="jpeg",dpi=1000)
