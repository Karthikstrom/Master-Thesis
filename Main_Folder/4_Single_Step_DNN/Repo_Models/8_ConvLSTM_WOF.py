...
path=r"C:\Users\Karthikeyan\Desktop\Github\Master-Thesis\Main_Folder\4_Single_Step_DNN\Plots\SS_ConvLSTM.jpeg"
...
bx.set_ylabel("Load")
plt.title("Single Step ConvLSTM Actual vs Prediction")
plt.xlim(600,1000)
plt.legend()
