...
class CriticNetwork(keras.Model):
    def __init__(self,fc1_dims=64,fc2_dims=124,fc3_dims=124,fc4_dims=32,name='critic',chkpt_dir='tmp/ddpg'):
...
class ActorNetwork(keras.Model):
    def __init__(self,fc1_dims=64,fc2_dims=124,fc3_dims=124,fc4_dims=64,n_actions=6,name='actor',chkpt_dir='tmp/ddpg'):
...
class Agent:
    def __init__(self,input_dims,alpha=0.00005,beta=0.00001,env=None,gamma=0.99,
                 n_actions=6,max_size=30000,tau=0.01,batch_size=64,no_of_episodes=900):
        ...
        self.a3_noise=self.Gaussian_Noise()
        self.a4_noise=self.Gaussian_Noise()
        self.a5_noise=self.Gaussian_Noise()
        self.a6_noise=self.Gaussian_Noise()
    ...
    def choose_action(self,observation,evaluate=False):
        ...
        self.a3_noise[self.step_counter],self.a4_noise[self.step_counter],
        self.a5_noise[self.step_counter],self.a6_noise[self.step_counter]]
        ...
        actions=np.reshape(actions,(6,1))
...
if __name__ == '__main__':
    ...
    for i in range(n_games):
        ...
        while not done:
            ...
            observation_,reward,done,info=env.step(action[0],action[1],action[2],action[3],action[4],action[5])
            agent.remember(observation,action,reward,observation_,done)
            score+=reward
