...
class Agent:
    def __init__(self,input_dims,alpha=0.00005,beta=0.00001,env=None,gamma=0.99,
                 n_actions=1,max_size=50000,tau=0.05,batch_size=32,no_of_episodes=8000):
    ...
    def OU_Noise(self):
        ...
        sigma_initial = 1.2 # Initial standard deviation of the noise
...
import pandas as pd
df_results = pd.DataFrame({'Load':load, 'PV': pv,'Bat_action':a1,'RTP':price,'pp':pp_list,'SOC':batt_soc})
